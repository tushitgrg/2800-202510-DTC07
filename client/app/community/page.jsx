    ...
    <div className="flex flex-col w-full justify-center items-center p-6">
      ...
      {hasMore && (
        <Button
          ...
          variant="outline"
          size="md"
          className="my-3 px-6 py-3 rounded-full text-white font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:scale-95 transition-all duration-200 bg-gradient-to-r"
        >
