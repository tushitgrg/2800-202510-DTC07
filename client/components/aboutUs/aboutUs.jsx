...
const AboutUs = () => {
  ...
  const teamCards = [
    {
      ...
      description:
        "A slightly small genius teenager who’s not quite of legal drinking age, but probably has 5+ years of dev experience. Always “busy” for no apparent reason... kids these days.",
    },
    {
      name: "Woojin Song",
      role: "Our Best Scrum Master & Spokesman",
      icon: <UserCircle2 className="size-6" />,
      description:
        "When you hear “wait a minute,” you know you’ve messed something up. The ultimate translator for non-native speakers, a lifesaver for all docs and grammar. Online nearly 24/7.",
    },
    {
      name: "Emanuel Molla",
      role: "Our Backend Developer",
      icon: <Target className="size-6" />,
      description:
        "Solves all our Git issues, APIs, and database mysteries. We suspect he’s a robot. He only stands up when it’s time to fix something critical. Rumor has it, his headset is directly routed into the backend.",
    },
    {
      name: "Jimmy Cho",
      ...
      description:
        "Low energy consumption. Just feed him iced coffee, smoke, and alcohol, then watch him create world-class UX/UI. Favorite line: “Good for you.” You better find him before 10 PM. After that, good luck. A low-key party king.",
    },
    {
      name: "Tracy Chung",
  ...
  const SectionHeader = ({ badge, title, text }) => (
    ...
    >
      ...
      <h2 className="text-3xl md:text-4xl font-bold tracking-tight pt-4">
        {title}
      </h2>
