      ...
      <div className="container px-4 md:px-6 relative">
        ...
        >
          ...
          <p className="max-w-[800px] text-muted-foreground md:text-lg">
            Our AI-powered platform makes studying efficient and effective with
            just a few clicks.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description:
                "Upload your notes, textbooks, or any study material you want to learn from.",
            },
            {
              step: "02",
              title: "Generate Study Materials",
              description:
                "Our AI instantly creates quizzes, flashcards, or summaries based on your content.",
            },
            {
              step: "03",
              title: "Study & Track Progress",
              description:
                "Use the generated materials to study and track your improvement over time.",
            },
          ].map((step, i) => (
            <motion.div
              key={i}
